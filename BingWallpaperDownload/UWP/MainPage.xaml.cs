    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            else
            {
                ...
                Hint.Text = resourceLoader.GetString("Hint/ImageThere");
            }
        ...
        public async void OpenFolderButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!success)
            {
                Hint.Text = resourceLoader.GetString("Hint/OpenFolderSpace") + resourceLoader.GetString("Hint/FailedExclamation");
            }
            else
            {
                Hint.Text = resourceLoader.GetString("Hint/OpenFolderSpace") + resourceLoader.GetString("Hint/SuccessedExclamation");
            }
        }
        ...
        public async void SetFolderButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (folder == null)
            {
                Hint.Text = resourceLoader.GetString("Hint/SetFolderSpace") + resourceLoader.GetString("Hint/FailedExclamation");
            }
            else
            {
                Hint.Text = resourceLoader.GetString("Hint/SetFolderSpace") + resourceLoader.GetString("Hint/SuccessedExclamation");
            }
        }
        ...
        private async void OpenBingButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (success)
            {
                Hint.Text = resourceLoader.GetString("Hint/BrowserLaunchedSpace") + resourceLoader.GetString("Hint/SuccessedExclamation");
            }
            else
            {
                Hint.Text = resourceLoader.GetString("Hint/BrowserLaunchedSpace") + resourceLoader.GetString("Hint/FailedExclamation");
            }
        }
